...
public class PdfReportGeneratorWarehousesInvoice
{
    ...
    public PdfReportGeneratorWarehousesInvoice(IConverter pdfConverter, IWebHostEnvironment environment, DeliveryCompanyService deliveryCompanyService, IHttpContextAccessor httpContextAccessor)
    {
            ...
            foreach (var item in page)
            {
                ...
                $"</td>" +
                  $"<td style=\"color: #535971 !important; text-align: center; border: none; padding: 12px; vertical-align: top;\">" +
                    $"<p style=\"padding-right: 8px;\">{item.UnchangingAmount}</p>" +
                $"</td>" +
                $"<td style=\"color: #535971 !important; text-align: center; border: none; padding: 12px; vertical-align: top;\">" +
                    $"<p style=\"padding-right: 8px;\">{item.Quantity}</p>" +
                $"</td>" +
                  $"<td style=\"color: #535971 !important; text-align: center; border: none; padding: 12px; vertical-align: top;\">" +
                    $"<p style=\"padding-right: 8px;\">{item.TotalSoldAmount}</p>" +
                $"</td>" +
                $"<td style=\"color: #535971 !important; text-align: center; border: none; padding: 12px; vertical-align: top;\">" +
  ...
  <table style=""width: 100% !important; margin-bottom: 0; border-collapse: collapse; font-size:16px !important; "">
         <thead style=""display: table-header-group;"">
            ...
            <th style=""vertical-align: middle; border-top: none; padding: 8px; text-align: center; font-size: 12px !important;"">
                <section><p style="" color:#000e16; font-size: 12px !important; padding-right:3px; font-weight:400;"">الكمية الأجمالية</p></section>
            </th>
           ...
           <th style=""vertical-align: middle; border-top: none; padding: 8px; text-align: center; font-size: 12px !important;"">
                <section><p style="" color:#000e16; font-size: 12px !important; padding-right:3px; font-weight:400;"">الكمية المباعة</p></section>
            </th>
