...
namespace lotus_blue.Hubs
{
    public class MessageHub : Hub
    {
        ...
        {
            Console.WriteLine($"Broadcasting conversation update: {conversationId} - {senderName}: {latestMessage}");
        ...
        {
            Console.WriteLine($"Sending message to conversation {conversationId}: {senderName}: {message}");
